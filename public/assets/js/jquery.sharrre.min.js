  ...
  (function () {
    ...
    return {
      ...
      get: function (b, c) {
        return a[b]
          ? new a[b](c)
          : (console.error("Sharrre - No platform found for " + b), !1);
      },
    };
  })();
          ...
          $(a.element)
            ...
            .append(
              '<div class="button digg"><a class="DiggThisButton ' +
                ...
                encodeURIComponent("" !== b.url ? b.url : a.options.url) +
                '"></a></div>'
            );
          var c = 0;
        ...
        popup: function (a) {
          window.open(
            "https://www.reddit.com/submit?url=" +
              encodeURIComponent(
                "" !== this.settings.url ? this.setting.url : a.url
              ),
            "",
            "toolbar=0, status=0,width=" +
              this.settings.popup.width +
  ...
  (function (a, b, c, d) {
    ...
    (f.prototype.init = function () {
      ...
      a.each(b.options.share, function (a, c) {
        c === !0 &&
          (b.platforms[a] = SharrrePlatform.get(a, b.options.buttons[a]));
      }),
        ...
        b.options.enableCounter === !0
          ...
          : "" !== b.options.template &&
            (b.renderer(), (b.options.count[name] = 0), b.rendererPerso()),
        "" !== b.options.template
        ...
        a(this.element).append('<div class="buttons"></div>'),
          a.each(b.options.share, function (a, c) {
            1 == c &&
              ...
              b.options.enableTracking === !0 && b.platforms[a].tracking());
          });
      }),
